        ...
        products.forEach(function (product, index) {
            $("#list").append(`<tr>
                                ...
                                <td>
                                    ...
                                    <a href="#deleteProductModal" class="delete" data-toggle="modal" onclick="sendInf('${product.id}','${product.name}')"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>`);
        });
    }
