                ...
                <div class="row align-items-center">
                    <div class="col-4">
                        <a href="#" class="navbar-brand text-white">
                            <img src="/image/logo_furuma.png" alt="Logo" width="100px" height="100px" class="d-inline-block align-text-top">
                        </a>
                    </div>
            ...
            <nav class="navbar navbar-expand-lg ">
                <div class="container-fluid">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link mx-4 text-dark" aria-current="page" href="#">Employee</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link mx-4 text-dark" aria-current="page" href="#">Customer</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link mx-4 text-dark" aria-current="page" href="#">Service</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link mx-4 text-dark" aria-current="page" href="#">Contract</a>
                        </li>
                    </ul>
