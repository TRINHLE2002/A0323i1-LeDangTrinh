...
public class House extends Service{
    ...
    public House(String service_name, double service_are, double service_cost, int service_max_people, int rent_type_id, String standard_room, String description_other_convenience, int number_of_floors) {
