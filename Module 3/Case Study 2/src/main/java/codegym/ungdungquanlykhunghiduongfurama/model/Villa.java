...
public class Villa extends Service{
    ...
    public Villa(String service_name, double service_are, double service_cost, int service_max_people, int rent_type_id, String standard_room, String description_other_convenience, double pool_area, int number_of_floors) {
