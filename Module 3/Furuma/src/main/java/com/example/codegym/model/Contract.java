...
public class Contract {
    ...
    public Contract(int contract_id, String contract_start_date, String contract_end_date, double contract_deposit, double contract_total_payment) {
        this.contract_id = contract_id;
        this.contract_start_date = contract_start_date;
        this.contract_end_date = contract_end_date;
        this.contract_deposit = contract_deposit;
        this.contract_total_money = contract_total_payment;
    }
    ...
    public String toString() {
        return "Contract{" +
                ...
                ", contract_total_payment=" + contract_total_money +
                '}';
    }
}
