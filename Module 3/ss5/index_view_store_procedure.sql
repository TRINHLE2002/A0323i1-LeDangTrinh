...
insert into products (productName,productPrice,productAmount,productDescription,productStatus) values
('Điện thoại 1', 11111 , 11 , 'Tốt', 'Còn Hàng' ),
...
explain select * from products where id = 2412;
...
alter view product_view as select * from products where id like '1%';
...
begin
insert into products(productName,productPrice,productAmount,productDescription,productStatus) value
('Điện Thoại 11 ' , 111111111 , 11 , 'Tốt' , 'Hết Hàng');
end //
delimiter ;
...
begin
update products
set id = 1, productName = 'Điện Thoại 12',productPrice = 121212, productAmount = 12, productDescription = 'Tốt', productStatus = 'Hết Hàng'
